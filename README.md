...
4. **Autoencoder + DenseNet block** 
   **This is the state of the art model.**
   ...
   <div align="center"><img width="350" height="300" alt="image" src="[https://github.com/user-attachments/assets/4b22448b-ba95-48cf-a4e2-0db781af2c81](https://github.com/ACM40960/project-heart-disease-prediction-models/blob/main/generated_plots/06_Loss_Curve_Autoencoder_DenseNet.png?raw=true)"/></div>
